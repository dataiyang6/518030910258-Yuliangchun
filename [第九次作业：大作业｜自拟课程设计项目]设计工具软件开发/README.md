...
部分示意图如下，详见`hw9_示范视频（经倍速处理）.mp4`及`hw9_作品集`。   
左上为原图（以明星图像作为示例图像）：   
